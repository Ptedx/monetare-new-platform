...
export interface IStorage {
  ...
  getAuditTrail(filters?: { userId?: number; entityType?: string; entityId?: string }): Promise<AuditTrail[]>;
}
...
export class DatabaseStorage implements IStorage {
  ...
  async getAuditTrail(filters?: { userId?: number; entityType?: string; entityId?: string }): Promise<AuditTrail[]> {
    const conditions = [];
